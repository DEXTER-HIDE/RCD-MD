...
smd(
  ...
  async (_0x5f0a63) => {
    try {
      let _0x4a2c9b = mtypes.includes(_0x5f0a63.mtype)
        ? _0x5f0a63
        : _0x5f0a63.reply_message;
...
smd(
  ...
  async (_0x1544ea, _0x3444c7) => {
    try {
      let _0x128f40 = await smdBuffer(
        "https://raganork-api.onrender.com/api/attp?text=" +
          (_0x3444c7 ? _0x3444c7 : "Please provide text to generate sticker") +
...
smd(
  ...
  async (_0x50fc92) => {
    try {
      let _0x2d0760 = mtypes.includes(_0x50fc92.mtype)
        ? _0x50fc92
        : _0x50fc92.reply_message;
...
smd(
  ...
  async (_0x52caf7) => {
    try {
      let _0x11d586 = mtypes.includes(_0x52caf7.mtype)
        ? _0x52caf7
        : _0x52caf7.reply_message;
...
smd(
  ...
  async (_0x37c100) => {
    try {
      let _0x5f32a5 = mtypes.includes(_0x37c100.mtype)
        ? _0x37c100
        : _0x37c100.reply_message;
...
smd(
  ...
  async (_0x29b369, _0x406491) => {
    try {
      let _0x5b20bd = pmtypes.includes(_0x29b369.mtype)
        ? _0x29b369
        : _0x29b369.reply_message;
      if (!_0x406491) {
      ...
      let _0x225e06 = await _0x29b369.bot.downloadAndSaveMediaMessage(
        _0x5b20bd
      );
...
smd(
  ...
  async (_0xa1cfa2, _0x4ec923) => {
    try {
      let _0x5a2037 = _0xa1cfa2.reply_message
        ? _0xa1cfa2.reply_message
        : _0xa1cfa2 && _0x4ec923
        ? _0xa1cfa2
        : false;
      let _0x8d0e84 = _0xa1cfa2.reply_message
        ? _0xa1cfa2.reply_message.text
        : _0x4ec923;
      ...
      let _0x4c5cf1 =
        _0x4ec923 === "white"
          ...
          : _0x4ec923 === "black"
          ? _0x242a85[1]
          : _0x242a85[Math.floor(Math.random() * _0x242a85.length)];
      ...
      let _0x51ed20 = await axios.post(
        "https://bot.lyo.su/quote/generate",
        _0x345fab
      );
      if (
        !_0x51ed20 ||
        _0x51ed20.status !== 200 ||
        !_0x51ed20.data ||
        !_0x51ed20.data.ok
      ) {
        return await _0xa1cfa2.send("*_Can't create quote sticker!_*");
      }
      let _0x3dabe8 = Buffer.alloc(
        _0x51ed20.data.result.image.length,
        _0x51ed20.data.result.image,
        "base64"
      );
      try {
        await _0xa1cfa2.send(
          _0x3dabe8,
          {
...
smd(
  ...
  async (_0x85089c, _0x29ac4f) => {
    try {
      ...
      let _0x24899a = await axios.get(
        "https://tinyurl.com/api-create.php?url=" + _0xe54a62
      );
    ...
    try {
      ...
      if (!_0xd51ec) {
        return _0x4cfc4e.reply(
          "*_Example : " + prefix + "fliptext RCD MD!_*"
        );
      }
      let _0x5c7a34 = _0xd51ec.split("").reverse().join("");
      await _0x4cfc4e.reply(
        "*「  Text Flipper Tool  」* \n*IGiven text :*\n" +
          _0xd51ec +
          "\n\n*Fliped text :*\n" +
          _0x5c7a34
...
smd(
  ...
  async (_0x3878b3, _0x4974a3) => {
    try {
      ...
      let { data: _0x3d14f3 } = await axios.get(
        'https://api.telegra.ph/createPage?access_token=d3b25feccb89e508a9114afb82aa421fe2a9712b963b387cc5ad71e58722&title=Suhail-Md+Bot&author_name=Astro_Info&content=[%7B"tag":"p","children":["' +
          _0x531993.replace(/ /g, "+") +
          '"]%7D]&return_content=true'
      );
      return _0x3878b3.reply(
        "*Paste created on telegraph*\nName:-" +
          util.format(_0x3d14f3.result.title) +
          " \nUrl:- " +
          util.format(_0x3d14f3.result.url)
      );
    } catch (_0x5d7e4a) {
      await _0x3878b3.error(
        _0x5d7e4a + "\n\ncommand: paste ",
        _0x5d7e4a,
        false
      );
...
smd(
  ...
  async (_0x31d7b) => {
    try {
      let _0xd092ed = pmtypes.includes(_0x31d7b.mtype)
        ? _0x31d7b
        : _0x31d7b.reply_message;
...
smd(
  ...
  async (_0x116242) => {
    try {
      let _0x2976f2 = audtypes.includes(_0x116242.mtype)
        ? _0x116242
        : _0x116242.reply_message;
      if (!_0x2976f2 || !audtypes.includes(_0x2976f2?.mtype)) {
        return _0x116242.reply("*_Uhh Dear, Reply to Any Video.!!_*");
      }
      let _0x2b56d1 = await _0x116242.bot.downloadAndSaveMediaMessage(
        _0x2976f2
      );
      const { toAudio: _0xfd0543 } = require("../lib");
...
smd(
  ...
  async (_0x5c9aa3) => {
    try {
      let _0x462db2 = audtypes.includes(_0x5c9aa3.mtype)
        ? _0x5c9aa3
        : _0x5c9aa3.reply_message;
      ...
      return await _0x5c9aa3.bot.sendMessage(
        _0x5c9aa3.jid,
        {
          audio: _0x357d23,
          mimetype: "audio/mpeg",
...
smd(
  ...
  async (_0x4ed07c) => {
    let _0xadff0d =
      _0x4ed07c.mtype === "videoMessage" ? _0x4ed07c : _0x4ed07c.reply_message;
    if (!_0xadff0d) {
      return _0x4ed07c.reply(
        "*_Uhh Dear, Reply To Animated Sticker or Gif!!_*"
      );
    }
    const { webp2mp4File: _0x3e4a6e } = require("../lib");
    let _0x4ab6cb = _0xadff0d?.mimetype || "";
    if (_0xadff0d?.mtype != "videoMessage" && !/webp/.test(_0x4ab6cb)) {
      return await _0x4ed07c.send(
...
function splitTextIntoLines(_0x2e8ff3, _0x1ba8fb, _0x469f3c) {
  ...
  for (const _0x1678b3 of _0x32429f) {
    const _0x56be5a =
      _0x38142d === "" ? _0x1678b3 : _0x38142d + " " + _0x1678b3;
  ...
  async (_0x54e3dc, _0x8cd246) => {
    try {
      ...
      if (_0x2cee76) {
        ...
        const { createCanvas: _0x238289 } = require("canvas");
