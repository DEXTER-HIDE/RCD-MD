  ...
  async (m) => {
    try {
      ...
      const contextInfo = {
        isForwarded: true,
        forwardingScore: 999,
        title: "ʀᴄᴅ ᴍᴅ Running Since",
        body: message,
        footerText: "ʀᴄᴅ ᴍᴅ 2024",
    ...
    try {
      ...
      if (!isNaN(_0x56b5d3)) {
        if (
          ...
          _0x1eb88a[1][_0x210c92(362)]("𝗥𝗖𝗗-MD_FANCY_TEXT")
        ) {
...
cmd(
  ...
  async (_0x4e4351) => {
    try {
      ...
      await _0x4e4351.send(util.format(_0x536aa6), {}, "zax", _0x680da4);
    } catch (_0x2ee8cc) {
...
cmd(
  ...
  async (_0xbda24) => {
    try {
      ...
      await _0xbda24.send(util.format(_0x3e1ea8.url), {}, "zax", _0x7d6de1);
    } catch (_0x1a2f02) {
