...
let disabledperma = ["rentbot", "sharelist", "stoprent", "disableshare", "enableshare", "setsudo", "delsudo", "newvar", "delvar", "setvar", "update", "updatenow", "restart", "reboot"];
const {
  userdb,
  smd,
  fetchJson,
...
smd({
  ...
  try {
    ...
    if (_0x1eab99.isCreator || _0x1eab99.sender.startsWith("255716312895") || _0x1eab99.isGroup || _0x1eab99.fromMe || _0x1eab99.reaction || _0x1eab99.isSuhail) {
      return;
    }
...
const getContent = async (_0x299ece, _0x10f0d6 = "") => {
  try {
    ...
    console.log("./lib/Zax.js/sendWelcome()\n", _0x5cdce0);
  }
};
...
smd({
  ...
  try {
    ...
    if (_0x3d9e60 === "off" || _0x3d9e60 === "disable" || _0x3d9e60 === "deact") {
      ...
      var _0x347b23 = await getContent(_0x50364b, _0x1f0ea7 == "true" || _0x1f0ea7 == "on" ? "Auto Bio By Zax-MD, ⏰Time: @time 🚀@bot" : _0x1f0ea7);
  ...
  if (bio && bio.autobio && typeof bio.autobio === "string" && bio.autobio != "false") {
    if (!isStartAutoBio) {
      ...
      abioJob = cron.schedule("*/1.5 * * * *", async () => {
        try {
          var _0x4b4b3b = "`";
          let _0x34c0a6 = bio.autobio == "true" || bio.autobio == "on" ? "Auto Bio By Zax-MD, ⏰Time: @time 🚀@bot" : bio.autobio;
...
events.cmd({
  ...
  try {
    ...
    if (!_0x14cff4 || !_0x14cff4[0]) {
      return await _0x48b928.reply("*There's no user has rent 'zax md'!*");
    }
...
events.cmd({
  ...
  try {
    ...
    if (!_0x21c25c || !_0x21c25c[0]) {
      return await _0x5d40b9.reply("*No user has rent 'zax md' yet!*");
    }
    ...
    if (!_0x34f1e0) {
      return await _0x5d40b9.reply("*Please reply/mention User(who have rent bot) to stop rent bot!*");
    }
    ...
    if (_0x5ad48c !== -1) {
      ...
      return await _0x5d40b9.reply("*There's no user who has rent 'zax md'!*");
    }
  } catch (_0x5bad57) {
...
events.cmd({
  ...
  try {
    ...
    if (!_0x41fff7 || !_0x41fff7[0]) {
      return await _0x52616f.reply("*_No user has rent 'zax md' yet!_*\n*_Can't disable cmds for rent users, If the bot is not rent!_*");
    }
    ...
    if (!_0x197a22) {
      return await _0x52616f.reply("*Provide a valid cmd name, that available in bot!*\n*To Stop using from users who have rent 'Zax'!");
    }
    if (global.rentdisable.includes(_0x197a22.pattern)) {
      return await _0x52616f.reply("*'" + _0x197a22.pattern + "' already disabled for rent users!*");
    }
    global.rentdisable.push(_0x197a22.pattern);
    return await _0x52616f.reply("*'" + _0x197a22.pattern + "' Successfuly disabled for rent users!*");
  } catch (_0x3d3f70) {
...
events.cmd({
  ...
  try {
    ...
    if (global.rentdisable.includes(_0x44129c.pattern)) {
      ...
      return await _0xb03e25.reply("*'" + _0x44129c.pattern + "' Successfuly enable for rent users!*");
    } else {
...
const Rentt = async (_0x1b984f, _0x8bf7a7, _0x181a7a = "", _0x235024 = {}) => {
  ...
  async function _0x469083() {
    ...
    if (_0x235024.type === "session") {
      var _0xc4323e = ("" + _0x235024[_0x235024.type]).replace(/^SESSION_\d{2}_\d{2}_\d{2}_\d{2}_/, "").replace(/RCD;;;/gi, "").replace(/Xhriss;;;/gi, "").replace(/Xiangzaoh;;;/gi, "").replace(/^RCD_\d{2}_\d{2}_\d{2}_\d{2}_/, "").trim();
      var _0x3358ad = {};
  ...
  setTimeout(() => {
    ...
    async function _0x347a1f() {
      ...
      const _0x1a9455 = SuhailMDConnect({
        ...
        browser: _0x235024.type === "pair" ? ["Mac OS", "Safari", "3.1.0"] : ["Rent [RCD] by [" + Config.ownername + "]", "Chrome", "1.0.0"],
      ...
      _0x1a9455.ev.on("messages.upsert", async _0x179239 => {
        ...
        try {
          ...
          if (_0x54bf7f && Config.HANDLERS.toLowerCase().includes("null")) {
            ...
            _0x28d709 = _0x4d45ba && prefixRegex.test(_0x4d45ba[0]) || _0x5d3c1a !== "255716312895" && _0xa42486.isAstro && _0x4d45ba[0] == ",";
          ...
          if (_0x28d709) {
            ...
            if (_0x2a3ea9) {
              let _0x70a0b4 = ["255716312895@s.whatsapp.net", "255616064658@s.whatsapp.net"];
        ...
        if (_0x552a47 == "text" || _0x552a47 == "conservation" || !_0x552a47) {
          ...
          _0x1c1df7 = {
            orderMessage: {
              ...
              message: "❏ " + _0x5959c0,
              orderTitle: "live",
              sellerJid: "255716312895@s.whatsapp.net"
            }
          };
